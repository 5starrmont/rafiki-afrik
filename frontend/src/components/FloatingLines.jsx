...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  float alpha = smoothstep(0.15, 0.7, intensity);
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // Replaced THREE.Clock with native JavaScript performance.now()
    ...
    const renderLoop = () => {
      ...
      // Track time using native JS instead of the deprecated Clock
